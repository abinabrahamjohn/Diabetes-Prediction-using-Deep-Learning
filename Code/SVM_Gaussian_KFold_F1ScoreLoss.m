...
%for training data) for SVM Gaussian Kernel and returns the mean F1 Score Error
function meanF1ScoreError = SVM_Gaussian_KFold_F1ScoreLoss(x, t, k,boxConstraint,kernelScale)
    kfold=k;
    rng(110);
    ...
    for k=1:kfold
        ...
        %create and train SVM with gaussian kernel model
        svm_model=fitcsvm(...
            xTrain, ...
            yTrain, ...
