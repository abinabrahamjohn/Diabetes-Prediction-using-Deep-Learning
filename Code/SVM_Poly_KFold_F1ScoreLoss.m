...
%for training data) for SVM Polynomial Kernel and returns the mean F1 Score Error
function meanF1ScoreError = SVM_Poly_KFold_F1ScoreLoss(x, t,k, boxConstraint,polynomialOrder)
    kfold=k;% K reduced to consider for system time taken to train polynomial kernel
    rng(110);
